# WhereWild Design System

<!--
Using Figma's [Code Connect](https://github.com/figma/code-connect).
-->

WhereWild Design System (WDS) is a design system based on Figma's Simple Design System (SDS). SDS shows how Figma’s Variables, Styles, Components, and Code Connect can be used alongside a React codebase to form a complete picture of a responsive web design system.
...
- Includes some example plugins for how to get the same data **without the Variables REST API**.
    - [Install plugins](https://www.figma.com/plugin-docs/plugin-quickstart-guide/) in Figma Design mode
